...
// Binary Snyk CLI releases need this files, so we are using
// https://www.npmjs.com/package/pkg#detecting-assets-in-source-code
// TODO(kyegupov): just specify the asset dir in the package.json
...
export function getDependencies(root, targetFile) {
  let config;
  let tempDirObj;
